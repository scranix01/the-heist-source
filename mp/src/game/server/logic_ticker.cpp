...
class CHeistTicker : public CLogicalEntity
{
public:
	DECLARE_CLASS(CHeistTicker, CLogicalEntity);
	DECLARE_DATADESC();
...
LINK_ENTITY_TO_CLASS(logic_ticker, CHeistTicker);

// Start of our data description for the class
BEGIN_DATADESC(CHeistTicker)
...
//-----------------------------------------------------------------------------
void CHeistTicker::InputTick(inputdata_t& inputData)
{
